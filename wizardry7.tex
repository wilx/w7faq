...
\item
  Females can become \class{Valkyrie}s, which are \class{Lord}s with less experience
...
\subsubsection{\race{Human}}\label{human}
...
Points needed to meet Class Requirements for \race{Human}:
...
\subsubsection{\race{Elf}}\label{elf}
...
\subsubsection{\race{Dwarf}}\label{dwarf}
...
Points needed to meet Class Requirements for \race{Dwarf}:
...
\subsubsection{\race{Gnome}}\label{gnome}
...
\subsubsection{\race{Hobbit}}\label{hobbit}
...
Points needed to meet Class Requirements for \race{Hobbit}:
...
\subsubsection{\race{Faerie}}\label{faerie}
...
Points needed to meet Class Requirements for \race{Faerie}:
...
\subsubsection{\race{Lizardman}}\label{lizardman}
...
Points needed to meet Class Requirements for \race{Lizardman}:
...
\subsubsection{\race{Dracon}}\label{dracon}
...
\subsubsection{\race{Rawulf}}\label{rawulf}
...
\subsubsection{\race{Felpurr}}\label{felpurr}
...
Points needed to meet Class Requirements for \race{Felpurr}:
...
\subsubsection{\race{Mook}}\label{mook}
...
Points needed to meet Class Requirements for \race{Mook}:
...
\subsubsection{\class{Fighter}}\label{fighter}
...
\subsubsection{\class{Mage}}\label{mage}
...
\subsubsection{\class{Priest}}\label{priest}
...
\item
  \class{Bishop}→\class{Valkyrie} (females only)\fshyp{}\class{Lord}\fshyp{}\class{Psionic}
\item
  \class{Psionic}→\class{Monk}
\item
  \class{Valkyrie} (females only)
...
\subsubsection{\class{Thief}}\label{thief}
...
\subsubsection{\class{Ranger}}\label{ranger}
...
\subsubsection{\class{Bard}}\label{bard}
...
\subsubsection{\class{Psionic}}\label{psionic}
...
\item
  Shadow Cloak useless if no \class{Thief}, \class{Ninja}, or \class{Bard} in party
\end{itemize}
\end{multicols}
...
\subsubsection{\class{Alchemist}}\label{alchemist}
...
\subsubsection{\class{Valkyrie}}\label{valkyrie}
...
\subsubsection{\class{Bishop}}\label{bishop}
...
\subsubsection{\class{Lord}}\label{lord}
...
\subsubsection{\class{Samurai}}\label{samurai}
...
\subsubsection{\class{Monk}}\label{monk}
...
\subsubsection{\class{Ninja}}\label{ninja}
...
actual \class{Thief} in the party instead of a \class{Bard}, \class{Ninja}, or \class{Ranger} substitute can
...
\paragraph{Ninjutsu} \class{Monk}s and \class{Ninja}s gain an AC bonus from this, in addition
...
\class{Ranger} You choose \class{Fighter} instead, add points to meet the minimum
requirements for a \class{Ranger}, and put any excess points where you want it
...
Faery \class{Thief} that I converted into a \class{Ninja} after hitting level~7 already
...
\subsubsection{\race{Elf} \class{Fighter}}
...
\subsubsection{\race{Felpurr} \class{Fighter}}
...
\subsubsection{\race{Faerie} \class{Thief}}
...
\subsubsection{\race{Elf} \class{Priest} (F)}
...
\subsubsection{\race{Elf} \class{Mage} (F)}
...
\subsubsection{\race{Elf} \class{Bard} (F)}
...
category is ``learned'' from a level up. For example, an \class{Alchemist}
scribes \spell{Stamina} instead of learning it the normal way. The \class{Alchemist}
...
\begin{multicols}{2}
\subsubsection{Thaumaturgy (\class{Mage} spellbook)}
...
has a \class{Bard} with the Poet's Lute. This becomes useless after mid-game however,
...
\subsubsection{Theology (\class{Priest} spellbook)}
...
spell the \class{Priest} has access to. After multiple castings of \spell{Armorplate},
...
\spellentry{Whirlwind} Another attacking spell for the \class{Priest}. Unfortunately,
...
\subsubsection{Theosophy (\class{Psionic} spellbook)}
...
whenyou got it.  The reason why this spell isn't too useful for the
...
\subsubsection{Alchemy (\class{Alchemist} spellbook)}
...
\class{Alchemist}. The fact that it doesn't seem to effectively hit most of the group
...
\spellentry{Fire Bomb} Once you get this, you can stop using \spell{Whipping
  Rocks} if you got it. It's the \class{Alchemist}'s equivalent of \spell{Fireball},
...
\spellentry{Deadly Air} The \class{Alchemist} mass target spell.  Quite useful. For
an air spell, it isn't resisted very much at all.

\spellentry{Death Cloud} The \class{Alchemist} instant-death spell. Not very great
...
someone with access to \class{Priest} spells, try to get \spell{Dispel Undead} if you
...
very effective way of stopping the nastier spells like
...
+2 item equipped. That being said, if you have a \race{Faerie} and got the \race{Faerie}
...
him or her--the \race{Faerie} will just lose the HP regen bonus because it cancels
...
they get an increased chance of a critical hit with \textsc{all} missile
...
-4 AC bonus, Regen +1, Psionic Resistance +50\%, usable only by \class{Psionic}s.
...
Control by the way: they LOVE \class{Psionic}s.
