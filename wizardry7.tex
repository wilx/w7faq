...
without wasting too much time: \place{New City} (using the fountain in the \place{Starter
Dungeon} or the one at Father Rulae), the Ra-sep-re-tep pool in the \place{Starter
Dungeon} (using the fountain in the same area) and \place{Munkharama} (at the Polar
Munk Society\ldots{} bring healing though\ldots{}). Get your swimming to at
least a 20 using these three places--the \place{Lost Temple} has a fountain that is
...
six spells you can cast at any time (\spell{Enchanted Blade}, \spell{Armorplate}, Magic
...
Casting any of the other battle-helping spells (such as \spell{Bless}, \spell{Haste},
...
as the one you wish to scribe in your book (for example, having \spell{Shrill
Sound} when you scribe \spell{Missile Shield} in the case of a mage), you will
...
scribes \spell{Stamina} instead of learning it the normal way. The Alchemist
will NOT gain any water spell points until he or she learns another
water spell by a level up--in this case \spell{Cure Paralysis}, \spell{Draining Cloud},
or \spell{Cure Disease}.
...
\item
  \spell{Haste}
\item
  \spell{Mindread}\protect\footnote{Only on your first time through--it tells you
...
\spell{Shrill Sound} and \spell{Magic Missile} are better, AND you get them
earlier. If you think the added chance of Nausea is worth it though, go right
ahead and get it.
...
spell the Priest has access to. After multiple castings of \spell{Armorplate},
...
\spellentry{Word of Death} The Priest equivalent of \spell{Nuclear
...
\spellentry{Psionic Fires} The Psionic equivalent of \spell{Fireball}, only
...
number. For the Psionic however, it takes a backseat for \spell{Psionic
...
useful when combined with \spell{Haste} to make sure you go first.

\paragraph{Level 3 spells (36 Theosophy)}

\spellentry{Dazzling Lights} The Psionic version of \spell{Prismic Missile},
it dispenses status ailments or just sheer damage. For some odd reason, this
...
\spellentry{Fire Bomb} Once you get this, you can stop using \spell{Whipping
  Rocks} if you got it. It's the Alchemist's equivalent of \spell{Fireball},
and as a Fire spell it hits quite often. Still, you may pass this up for the
Cloud-type spells you get in this batch of spells.
...
kill Father Rulae in \place{New City} and Brother TShober at \place{Eryn River} for
...
someone with access to Priest spells, try to get \spell{Dispel Undead} if you
...
mean after deciding where to go after \place{New City}--anywhere but
\place{Orkogre Castle}, \place{Dionysceus} (via the poppy fields), and
\place{Munkharama} is lethal.

\subsubsection{\place{New City}}\label{new-city}

Monsters Encountered (varies by area of \place{New City}):
...
somewhere\ldots{} you must have found \textsc{something} resembling paper in
there.
...
middle of \place{New City}, but you have to ``donate'' all your gold.  Better to wait
until later when you can buy \spell{Cure Disease} potions in \place{Munkharama} or learn the
...
It's a way into \place{Old City}. You'll figure out how to get in after you help
Barlone in the \place{Rattkin Ruins}' Funhouse with a favor. Maybe Professor
Wunderland was the friend he was speaking of--after all, he IS a Rattkin, and
he IS interested in \place{Old City}. Perhaps mentioning the place Barlone mentioned
...
Nose around \place{Nyctalinth} and wake up a few Savant Androids lying around Don't
...
\subsubsection{\place{Orkogre Castle}}\label{orkogre-castle}
...
Much, \textsc{much} later in the game. \place{Isle of Crypts} to be exact. Look for a
...
You wanted to know how to beat it though: You'll \textsc{need} the \spell{Air
...
to sleep, and ready your \spell{Dispel Undead} and any bombs that you may have found
or bought.  You may want some \spell{Cure Lesser Condition} potions in case a
party member manages to run away from the fight because of the "Terror"
status the Ravens inflict on you.  \spell{Cure Paralysis} potions are nice
too.

\subsubsection{\place{Munkharama}}\label{munkharama}
...
\item {\RaggedRight\ \place{Munkharama} and \place{Land of Dreams}\protect\footnote{\place{Land of Dreams}-only
...
already. Ask him about the other name you saw with ``\place{Land of Dreams}'' on the
front door for answers the Munk will like.

\faqentry{OK, I'm in the \place{Land of Dreams}, I stepped through the black door,
...
However, the Monks are at least weak against \spell{Asphyxiation} (or a mass
target damage spell like \spell{Nuclear Blast}), so if you have that and Cure
Disease, they'll be an easy source of XP for you. Keep in mind that they
don't have a lot of hit points if you try using \spell{Nuclear Blast} or another
...
had a mage that changed profession to a Bishop), the others shouldn't be too
much of a problem if you are faster. This is why you needed to find the exit
first, so that you can come here in better health. However, if you cannot
defeat the Lord of the Dark Forest at this point, you have no hope of getting
the \qmwordqm{CRYPT} map before someone else, as it means that you are too
low level to effectively kill him--by the time you're not, the map will be
gone.
...
expert mode you will \textsc{need} either \spell{Word of Death} on two
...
\subsubsection{\place{Dionysceus}}\label{dionysceus}
...
\begin{multicols}{2}\WviiTwoColumnSetup
  ...
  \item Second level\fshyp{}\place{Temple of Divine Order}
    ...
    \item \place{Tower Pit Exit}
      \begin{itemize}
        \tightlist
      \item See \place{Temple of Wanderers} and \place{Tower's Top} (except any fixed
        encounters)
      \end{itemize}
...
Do the Save\fshyp{}Restore method. Save each step \textsc{only} if at most 1
...
it on someone (an elf character preferrably, as elves already have hypnosis
...
Wanderers after clearing out the Starter Dungeon and \place{New City}, so don't worry
...
back to the \place{Temple of Eternal Night}, which can be a blessing or a pain
...
Sounds like you're in the \place{Temple of Deadly Coffers}. You're just going to have
...
You need a key from the first area of the \place{Temple of Deadly Coffers} where the
...
\faqentry{Where is everything in the \place{Temple of Wanderers}? It just looks like
  a bunch of deadends.}
...
\emph{Don't} put it on anyone that doesn't already have a Regen +1 or a Regen
+2 item equipped. That being said, if you have a Faerie and got the Faerie
Cap from the chest in the \place{Temple of Deadly Coffers}, or the one with
the Chrome Key in the \place{Temple of Wanderers}, it is safe to put it on
him or her--the Faerie will just lose the HP regen bonus because it cancels
out. As a note about negative Regen items, the game appears to take the
highest regeneration bonus out of all the items you have, and add the lowest
negative regeneration penalty of the items you have to it, to get an end
result. That means that if you have a Ring of Demons and both Gowns of Divine
Mail on the same character, that character ends up with no regeneration
bonus, NOT a Regen +2 bonus. So that Regen +1 item allows you to have as many
-1 regen items equipped as you want.
...
\place{New City} and is used for your (more profitable) mission.
...
\subsubsection{\place{Rattkin Ruins}}\label{rattkin-ruins}
...
\place{Nyctalinth}) and explore around. You'll find something interesting (not to
...
1$\times$1 pillars? Use the Bonsai Tree you got from Murkatos' \place{Inner Sanctum}
...
It guards the \qmwordqm{BOAT} Map. Talk to H'Jenn-Ra T'Rang in \place{Nyctalinth} to
...
\subsubsection{\place{Old City}}\label{old-city}
...
\subsubsection{\place{Nyctalinth}}\label{nyctalinth}
...
for an NPC--use \spell{Missile Shield} to stop the bullets he shoots at you most of
...
look for the TX-Coder in the Observation Center. Otherwise you won't be able
...
you're going grave robbing! \texttt{:)} You also have to dig out the grave of
...
you feel like; you stepped in every square so that you don't have to \spell{Cure Poison} as many times, saving on mana.
...
\subsubsection{\place{Witch Mountains}}\label{witch-mountains}
...
\place{Giant Cave}. That means you're going to be looking for a path DOWN, so
...
find it first--you will go there later. If you end up near a river, you're in
the wrong direction--you're on the \place{Eryn River} right now, which you've
been to before.

\faqentry{So what's up the path that you told me not to go up right now?}

Well after the \place{Giant Cave}, you should climb up and explore. Besides flower
hunting (and always save before trying to pick any flower now!)  you are also
looking for the entrance to the \place{Witch Cave}, a very high cliff that doesn't
...
\subsubsection{\place{Witch Grove}}\label{witch-grove}
...
\subsubsection{\place{Witch Cave}}\label{witch-cave}
...
\subsubsection{\place{Ukpyr Mountains}}\label{ukpyr-mountains}
...
\subsubsection{\place{Sphinx Cave}}\label{sphinx-cave}
...
got from attempting to get the Wand Majestik in \place{New City} is used here--you
...
\subsubsection{\place{Isle of Crypts} \& \place{Mandolian Isles}}\label{isle-of-crypts-and-mandolian-isles}
...
\subsubsection{\place{Dragon Mountains}}\label{dragon-mountains}
...
\subsubsection{\place{City of Sky}}\label{city-of-sky}
...
\subsubsection{\place{Hall of Gorrors} (in the \place{Isle of
...
Slow and Boring Way--Silence him and whack away. Use \spell{Armormelt} to speed
things up.
...
him the same way as Horragoth, minus the \spell{Word of Death}.
...
\subsubsection{\place{Hall of the Past}}\label{hall-of-the-past}
...
want \spell{Dispel Undead}, Astral Gate, \spell{Fire Shield}\ldots{}basically
all the commonly used spells I listed waaay earlier. If you didn't use them
before, you're definitely going to be using them here eventually. The only
exception is probably \spell{Asphyxiation}--most things in here aren't affected by
it. Bring lots of Moser's Mojo Tea your first time through, as well as Heavy
...
\subsubsection{\place{Tomb of the Astral Dominae}}\label{tomb-of-the-astral-dominae}
...
You \emph{did} visit the Forbidden Zone in \place{New City} after getting that
strange information from the Savant Berserker and the Observation Center in
\place{Nyctalinth} and the Comm-Link Device\ldots{}didn't you?
...
\paragraph{Mind Control} Kill the Psi-Beast(s) on the \place{Temple of Eternal Night}
  level of \place{Dionysceus} and return to the room the Danes were in on the same
...
get items better than what you should normally be getting if you go ASAP:
...
\paragraph{\place{New City}} In the Control Center, stick the Black Wafer instead of
the Control Card in the slot to summon Savant Guards and Troopers.

\paragraph{\place{Orkogre Castle}} In the area below the prison; you must step in the
square you fall in to respawn.

\paragraph{\place{Greater Wilds}} You will find an area that has a path circling a
...
\paragraph{Armor} Anything you can buy in \place{New City} should transfer.  Also,
...
Arbalest.  Any weapon you can buy in the \place{New City} area when you initially
