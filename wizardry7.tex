...
\usepackage[paper=A4,twoside,DIV=12,BCOR=6mm]{typearea}
...
\usepackage[leftmargin=0.5\leftmargin,rightmargin=0.5\rightmargin]{quoting}
\renewcommand*{\quotingfont}{\addfontfeature{StylisticSet=2,Ligatures={Common,Contextual,Historic,TeX},RawFeature={+salt}}\itshape}
\usepackage{multicol}
...
%\setmainfont[Ligatures={TeX,Common,Discretionary}]{Linux Libertine O}
\setmainfont[Ligatures={TeX,Common,Discretionary}]{Libertinus Serif}
...
\newcommand{\WviiNeedSpace}{%
%\Needspace*{4\baselineskip+\parskip}%
}
\makeatother

\makeindex[name=monsters,title=Monsters index,intoc]
\makeindex[name=npcs,title=NPCs index,intoc]
\makeindex[name=spells,title=Spells index,intoc]
\makeindex[name=places,title=Places index,intoc]
\makeindex[name=items,title=Game items index,intoc]
...
\DeclareRobustCommand{\indexGameItem}[1]{\index[items]{#1}}
\DeclareRobustCommand{\gameItem}[1]{\texorpdfstring{#1\indexGameItem{#1}}{#1}}
\DeclareRobustCommand{\gameItemB}[2]{\texorpdfstring{#1\indexGameItem{#2}}{#1}}

%\makeatother

\usepackage{stackengine}
\newcommand\stats[7]{%
  \stackengine{\Sstackgap}{#1}{\tiny STR}{O}{c}{F}{T}{S}%
  \quad%
  \stackengine{\Sstackgap}{#2}{\tiny INT}{O}{c}{F}{T}{S}%
  \quad%
  \stackengine{\Sstackgap}{#3}{\tiny PIE}{O}{c}{F}{T}{S}%
  \quad%
  \stackengine{\Sstackgap}{#4}{\tiny VIT}{O}{c}{F}{T}{S}%
  \quad%
  \stackengine{\Sstackgap}{#5}{\tiny DEX}{O}{c}{F}{T}{S}%
  \quad%
  \stackengine{\Sstackgap}{#6}{\tiny SPE}{O}{c}{F}{T}{S}%
  \quad%
  \stackengine{\Sstackgap}{#7}{\tiny PER}{O}{c}{F}{T}{S}%
}
...
\DeclareRobustCommand{\WviiSPOT}{\mbox{\monster{\textasteriskcentered\,S\,P\,O\,T\,\textasteriskcentered{}}}}
\DeclareRobustCommand{\WviiDOOM}{\mbox{\monster{\textasteriskcentered\,D\,O\,O\,M\,\textasteriskcentered{}}}}
\DeclareRobustCommand{\WviiSPAWN}{\mbox{\monster{\textasteriskcentered\,S\,P A W\,N\,\textasteriskcentered{}}}}
...
different company on a game similar in view to \CotDS. If you liked
\CotDS, you'll probably like his upcoming game as it seems similar. Try
visiting \url{http://www.heuristicpark.com}.  (Unfortunately it is quite
buggy\ldots{})
...
\item
  Males can wear the \gameItem{Cameo Locket}.
\end{itemize}
\columnbreak
...
\item
  \gameItem{Cameo Locket} is only attainable by importing a party from Bane of the
...
\item
  Females can use certain items like \gameItem{Stud-Cuir Bras} and
  \gameItem{Jazeraint Skirts}. (Sorry, no cross-dressers in the game.) Some of these items
...
\item
  \gameItem{Diamond Ring}, one of the better female-only items, must be imported
...
%
Base \race{Human} stats: \stats{9}{8}{8}{9}{9}{8}{8}
...
%
Base \race{Elf} stats: \stats{7}{10}{10}{7}{9}{9}{8}
...
\item
  Combat-types can take advantage of a Race-specific weapon (\gameItem{Elven Bow}).
\item
...
%
Base \race{Dwarf} stats: \stats{11}{6}{10}{12}{7}{7}{7}
...
%
Base \race{Gnome} stats: \stats{10}{7}{13}{10}{8}{6}{6}
...
%
Base \race{Hobbit} stats: \stats{8}{7}{6}{9}{10}{7}{13}
...
%
Base \race{Faerie} stats: \stats{5}{11}{6}{6}{10}{14}{12}

\begin{multicols}{2}\WviiTwoColumnSetup%
\WviiNeedSpace{}Perks:%
\begin{itemize}
\item
  Character always start with \gameItem{Gossamer Gown (U)}, \gameItem{Gossamer Gown (L)},
  \gameItem{Faerie Stick}, \gameItem{Faerie Dust}(5), and \gameItem{Lt.\ Heal}(3) regardless of class.
\item
...
\item
  Natural spellcaster
\item
  Race specific helmet (\gameItem{Faerie Cap})
\item
  Race \& class specific weapon (\gameItem{Cane of Corpus} for the \race{Faerie} \class{Ninja})
\end{itemize}
\columnbreak
...
\item
  ...
  using sometimes irreplaceable equipment such as the \gameItem{Poet's Lute}.
\item
...
\item
  \class{Alchemist}
\item
  \class{Bard} -- A pointless choice after playing as you do not get the \gameItem{Poet's
  Lute}.
\item
...
%
Base \race{Lizardman} stats: \stats{12}{5}{5}{14}{8}{10}{3}
...
%
Base \race{Dracon} stats: \stats{10}{7}{6}{12}{10}{8}{6}
...
%
Base \race{Rawulf} stats: \stats{8}{6}{12}{10}{8}{8}{10}
...
%
Base \race{Felpurr} stats: \stats{7}{10}{7}{7}{10}{12}{10}
...
%
Base \race{Mook} stats: \stats{10}{10}{6}{10}{7}{7}{9}
...
\subsection{\class{Fighter}}\label{fighter}%
%
Requirements: \stats{12}{0}{0}{0}{0}{0}{0}
...
%
Requirements: \stats{0}{12}{0}{0}{0}{0}{0}
...
\subsection{\class{Priest}}\label{priest}%
%
Requirements: \stats{0}{0}{12}{0}{0}{0}{0}%
%
\begin{multicols}{2}\WviiTwoColumnSetup%
Perks:
\begin{itemize}
...
%
Requirements: \stats{0}{0}{0}{0}{12}{8}{0}
...
\item
  Class specific weapon (\gameItem{Thieves Dagger}) that is cursed, allowing use as
...
%
Requirements: \stats{10}{8}{8}{11}{10}{8}{8}
...
\item
  Class specific weapon and accessory (\gameItem{Estoc de~Olivia}, \gameItem{Forest Cape})
\item
...
%
Requirements: \stats{0}{10}{0}{0}{12}{8}{12}
...
\item
  Learns Legerdemain
\item
  Starts with a \gameItem{Poet's Lute} (unless character is a \race{Faerie})
\item
  Increased skill points to Physical
\end{itemize}
\columnbreak
...
%
Requirements: \stats{10}{14}{0}{14}{0}{0}{10}
...
\item
  Class-specific accessory (\gameItem{PK Crystal})
\item
...
%
Requirements: \stats{0}{13}{0}{0}{13}{0}{0}
...
\item
  Cannot be silenced
\item
  Starts with \gameItem{Cherry Bomb} (unless starting character is a \race{Faerie})
\item
  Class specific accessory (\gameItem{Medicine Bag})
\item
  Increased skill points to Academia
\item
  Limited Healing capabilities (\spell{Heal Wounds})
...
%
Requirements: \stats{10}{0}{11}{11}{10}{11}{8}
...
\item
  Class-specific weapon (\gameItem{Maenad's Lance})
\item
  May use a majority of weapons and the strongest armor available
\item
...
%
Requirements: \stats{0}{15}{15}{0}{0}{0}{8}
...
%
Requirements: \stats{12}{9}{12}{12}{9}{9}{14}
...
%
Requirements: \stats{12}{11}{0}{9}{12}{14}{8}
...
\item
  Class specific weapons and armor (\gameItem{Muramasa Blade}, \gameItem{Do-Maru~(U)} and (L),
  \gameItem{Tosei-Do~(U)} \& (L), \gameItem{Hi-Kane-Do~(U)} \& (L), \gameItem{Kabuto})
\item
  Increased skill points to Weapon
\end{itemize}
\columnbreak
...
%
Requirements: \stats{13}{8}{13}{0}{10}{13}{8}
...
%
Requirements: \stats{12}{10}{10}{12}{12}{12}{0}
...
\item
  Class specific weapons, armor, and accessory (\gameItem{Sai}, \gameItem{Nunchuku}, \gameItem{Ninjato},
  \gameItem{Ninja Cowl}, \gameItem{Ninja Garb~(U)}, \gameItem{Ninja Garb~(L)}, \gameItem{Tabi Boots}, \gameItem{Blackbelt of 5
  Flowers})
\end{itemize}
\columnbreak
...
\item
  May only equip \gameItem{Ninja Cowl}, \gameItem{Ninja Garb~(U)} \& (L), \gameItem{Tabi Boots}, and race
...
fountain in the same area) and \place{Munkharama} (at the \place{Polar Munk
...
worthwhile like \npc{Belcanzor} for his items or \npc{Dame Ke-Li} for her \gameItem{Ankh}s. Be
...
don't want to mistake \monster{Night Rooks} for \monster{Vampire Vultures}.
In most cases however, it is easy to figure out what the monster is after a
round, or even based on where it is. Putting points into this is really up to
your strategy, but it goes up naturally over time, albeit slowly.
...
effective---other than \spell{Magic Screen}, \spell{Armorplate},
\spell{Locate Person}, and \spell{Enchanted Blade} scrolls, \spell{Knock-Knock} scrolls
...
has a \class{Bard} with the \gameItem{Poet's Lute}. This becomes useless
after mid-game however, as you'll have ways of dealing with multiple targets.
...
spell after you get the \gameItem{Journey Map Kit}, as you can easily check
which way you are facing by using the map.
...
\spellentry{Fireball} Once you get this, you'll be avoiding usage of
\spell{Magic Missile} except on Undead and fire-resistant monsters.
...
damage to nothing when it is coming from something strong, although
\monster{Fire Crow} breath will be much less painful.
...
pathetic \monster{Vulture} at a level~1 casting to perhaps \monster{Fieros}
and \monster{Myxlmynx} at level 7 (which are pretty darn useful). The best
...
\spellentry{Wizard Eye} Gives an overhead view of the area---just like you
had a \gameItem{Journey Map Kit}. (Surprise\ldots{}) Skip this spell if I
were you, unless you've been skimping on your Mapping skill or don't know if
there is a secret passage behind a wall.
...
Light Resistance, like \monsterB{Man~O'~Groves}{Man O' Groves}.
...
to get back charges on items like the \gameItem{Amulet of Asphyxiation}.
...
like \monster{Spectral Ravens} or \monster{Spectral Moths} are considered
undead as well. Don't expect it to work too well on some unique undead
monsters, with a very notable exception of the ones in \place{Witch
  Mountains}.
...
\monster{Umpani}, most \monster{Munks}, \monster{Gorn Rangers}, and other
Alchemical spellcasters.
...
spell would be nicer if it actually healed more damage---a level~1
\spell{Healthfull} seems to heal around 1--4 damage; you do the math. Still,
it's group healing, and that's always nice.
...
and heal you with that damage. Your spellcaster will never need to cast
\spell{Heal Wounds} on him or herself again. It works on a \emph{lot} of
enemies, but don't expect it to work on the real nasties like \monster{Rexx}
or \monster{Godzylli} very often---even at level~7.
...
of \monster{Rattkin Rogues}\fshyp{}\monsterB{Bandits}{Rattkin Bandits}).
...
\spellentry{Illusion} Summons monsters to fight for
you. \monster{Fantasmogoras} are at the high end of things
that are summoned by this. The best out of the three summon spells if you
like instant death spellcasters.

\spellentry{Wizard Eye} Gives an overhead view of the area---just like you had
a \gameItem{Journey Map Kit}. (Surprise\ldots{}) Skip this spell if I were you, unless
...
something in the process (sometimes something nasty like a \monster{Vampire Vulture} or
a \monster{Dragorra}).
...
resistance like \monsterB{Man~O'~Groves}{Man O' Groves}. If \spell{Dazzling Lights} or
...
\monster{Spectral Moths} to \monster{Godzylli} and \monster{Bloodwyrms}. The
best summoning spell out of the three if you want sheer muscle; heck, it's
the best period since the \monster{Godzylli} can last much longer than the other
summoned creatures.
...
\item
  ...
  want, or drop it if you want it around just in case (\place{Thesminster
    Abbey} in \place{New City} is a good place to drop items as it is often
  used and rather large). Try not to drop \textlcsc{TOO} many items
  however---there is a set amount of items that can be dropped in each map
  area.
\item
...
\begin{itemize}
\item Name of Area
\item List of monsters encountered; “\textsuperscript{fixed}” -- can only be fought in a fixed
...
\item
  \monster{Alliphoots}\textsuperscript{fixed}
\item
  \monster{Rattkin Rogues}\textsuperscript{fixed}
\item
  \monster{Rattkin Bandits}\textsuperscript{fixed}
\end{twocolumnitemize}
...
decide whether or not you actually want to help \npc{K'borra} T'Rang, and
...
\item
  \monster{Night Rooks}\textsuperscript{fixed}
\item
  \monster{Ra-sep-re-tep}\textsuperscript{fixed}
\end{itemize}
\end{itemize}
...
\item
  \monster{Savant Troopers}\textsuperscript{fixed}
\item
  \monster{Savant Controllers}\textsuperscript{fixed}
\item
...
Think of \place{New City} as a bigger version of the \place{Starter Dungeon},
except with stores and healing that you have to pay for, for now. Definitely
...
referring to a certain always-jammed door near the \place{Marina}, buy a
\gameItem{Knock-Knock} scroll from \npc{Belcanzor} and have someone with at
least 1 point in scribe use it on the door\ldots{}but save first. Either that
or use a level 6 \spell{Knock-Knock} spell to open the door. Very useful treasure in
the chest behind it, considering how early in the game it is.

\faqentry{What's with the \gameItem{Wand Majestik} in the \place{Curio
    Museum}? I stick my hand in but I can't grab it! All I get is this weird
  stone when I leave my hand in there and my leader gets diseased!}

\emph{Don't} stick your hand in there unless you have a way to cure your
first character of disease. You can use \npc{Father Rulae} in the
\place{Abbey} in the middle of \place{New City}, but you have to ``donate''
all your gold.  Better to wait until later when you can buy \spell{Cure
  Disease} potions in \place{Munkharama} or learn the spell yourself, as the
Wand isn't going anywhere anyway.

\faqentry{Can I use the boat \npc{Sogheim} has in the \place{Marina}?}
...
help \npc{Barlone} in the \place{Rattkin Ruins}' \placeB{Funhouse}{Rattkin
  Funhouse} with a favor. Maybe \npc{Professor Wunderland} was the friend he
was speaking of---after all, he \textlcsc{IS} a Rattkin, and he \textlcsc{IS}
interested in \place{Old City}. Perhaps mentioning the place \npc{Barlone}
mentioned will help jog his memory.

\faqentry{What's the \gameItem{Book of Fables} for? I managed to sneak past
  the \monster{Savant Android} guarding it with my fastest character.}
...
\faqentry{I found a \gameItem{Black Wafer}. What does it do?}
...
You walk in. \verb|:)| You mean inside the inside area? Get the \gameItem{Control
...
Use the \gameItem{Comm-Link Device} from the \place{Umpani Detache}.

\faqentry{What can I do with the computer? It wants me to login to some
  server.}

Nose around \place{Nyctalinth} and wake up a few \monster{Savant Androids}
lying around Don't forget to nose around the \place{Observation Center} there
for some other answers. This is where the information you got in those two
places is used.

\faqentry{How do I open the \place{Security Cell}?}

Whichever server you didn't use (or used but it didn't work) the first time,
use it now.

\faqentry{Nooo! This isn't fair!!! Why isn't the \qmwordqm{LEGEND} map in \place{New
  City}?!?}

It tends to disappear \textlcsc{VERY} fast for some odd reason. Consequently,
return the \gameItem{Holy Work} to \npc{Xen Xheng} as soon as possible and go
...
\tightlist
\item
  \monster{Dragonlizards}\textsuperscript{fixed}
\item
  \monster{Fungus Oozes}\textsuperscript{fixed}
\item
  \monster{Crawling Wastes}\textsuperscript{fixed}
\item
  \monster{T'Rang Watchers}\textsuperscript{fixed}
\item
  \monster{T'Rang Wilders}\textsuperscript{fixed}
\item
  \monster{T'Rang Guarders}\textsuperscript{fixed}
\item
  \monster{Rattkin Hunters}\textsuperscript{fixed}
\item
  \monsterB{Rattkin Thieves}{Rattkin Thief}\textsuperscript{fixed}
\item
  \monster{Rattkin Bandits}\textsuperscript{fixed}
\item
  \monster{Dane Initiates}\textsuperscript{fixed}
\item
  \monster{Dane Disciples}\textsuperscript{fixed}
\item
  \monster{Boar Weevils}\textsuperscript{fixed}
\item
  \monster{Venom Weevils}\textsuperscript{fixed}
\item
  \monsterB{Rattkin Thieves}{Rattkin Thief}
\item
  \monster{Rattkin Hunters}
...
\tightlist
\item
  \monster{Shadow Guardian}\textsuperscript{fixed}
\item
  \monster{Spectral Ravens}\textsuperscript{fixed}
\end{itemize}
\end{twocolumnitemize}

\faqentry{How the heck do I get into the \place{Throne Room}? I haven't found
  a key for the place!}
...
No, you have to get the \gameItem{Prison Keys} from Murkatos' \place{Outer Sanctum}.

\faqentry{\emph{Glares} OK, and how do I get in the \place{Outer Sanctum}?}

You'll need a \gameItem{Polished Steelplate} from below to reflect a beam of
light into the gate. Funny, why does my \spell{Detect Secret} eye glow when I
pass by that splot of blood in front?

\faqentry{I found these \gameItem{Boney Combs and Brushes}. When is it used?}

Much, \textlcsc{much} later in the game. \place{Isle of Crypts} to be
exact. Look for a hideous Gorn woman there.

\faqentry{Hey! The chest in the \place{Gorn King's room} is empty! What
  gives?}
...
summon help with
\spell{Conjuration}\fshyp{}\spell{Illusion}\fshyp{}\spell{Create Life}, call
...
of the chest includes the nifty \gameItem{Gem of Power}, which can, when
invoking it's special power, give a character the Power Strike Personal Skill
at the cost of losing the Gem; you may want to use the Gem as a protective
item instead for a while however---it grants a −2~AC bonus to the wearer
...
\item
  \monster{T'Rang Wilders}
\item
  \monster{Nightmares}\textsuperscript{L}
\item
  \monster{Dream Weavers}\textsuperscript{L}
\item
  \monster{Nightmares}\textsuperscript{fixed, L}
\item
  \monster{Dream Weavers}\textsuperscript{fixed, L}
\item
  \monsterB{Furies}{Fury}\textsuperscript{fixed, L}
\end{itemize}
...
\item
  \monster{Frothing Munks}\textsuperscript{fixed}
\item
  \monster{Leper Giants}\textsuperscript{fixed}
\item
  \monster{Lord of Dark Forest}\textsuperscript{fixed}
\end{itemize}
...
\tightlist
\item
  \monster{Skeleton Lords}\textsuperscript{fixed}
\end{itemize}
\end{twocolumnitemize}
...
\faqentry{What do I do at the \place{Land of Dreams}? The \npc{Palace Munk} doesn't
  like my answers!}
...
\faqentry{Is there something special about that middle area in
  \place{Munkharama} with \npc{Phoonzang}'s statue?}
...
\faqentry{What do I do with the \gameItem{Notched Shaft} I found?}
...
\faqentry{I can't find the \gameItem{Holy Work}!}
...
with access to \spell{Silence} or the \gameItem{Silent Lyre}, or (for the
power hungry) characters high level enough to shrug off \spell{Death} and
\spell{Fireball} spells.  Then you have to hope that the characters with
\spell{Silence} don't get paralyzed. \spell{Nuclear Blast} tends to not work
as well as \spell{Word of Death} on undead. There's no way you can take more
than 2 turns of spells from the \monster{Skeleton Lords} without getting
someone clobbered to death, even with \spell{Magic Screen} up. If you can,
you're lucky---\spell{Death} and 6 \spell{Fireball}s have a nasty effect on
...
\begin{twocolumnitemize}{Monsters encountered:}
  ...
  \item Second level\fshyp{}\place{Temple of Divine Order}
    ...
    \item Third level\fshyp{}\place{Temple of Eternal Night}
      ...
      \item \monster{The Beast}\textsuperscript{fixed}
    ...
    \item Sixth level\fshyp{}\place{Temple of Wanderers}
      ...
      \item \monster{Boar Weevils}
      \item \monster{Venom Weevils}
      \item \npc{Magna Dane}\textsuperscript{fixed}
      \end{itemize}
    ...
    \item \place{Tower's Top}
      ...
      \item \WviiSPAWN{}\textsuperscript{fixed}
      \item \monster{Vampire Vultures}
      \item \monster{Wraiths Spirits}
      \end{itemize}
\end{twocolumnitemize}

\faqentry{I can't make it through the \place{Poppy Field} to get here! Are you nuts?}
...
potions to stay awake if necessary, and if you have the \gameItem{Deadman's
  Hair}, equip it on someone (an elf character preferably, as elves already
have hypnosis resistance and this will boost it).
...
Buy some \gameItem{Jonga Powder} from \npc{Almagorte} if you can't take the
traps. (I can't unless \place{Dionysceus} is the last area for me to tackle
before trying to go to the \place{Dragon Mountains}.) On most of the levels
there will be an urn like the one in that little 1$\times$1 arched area you
saw right after entering the Temple of the Initiate. Use some \gameItem{Jonga
  Powder} there. You'll need to buy \gameItem{Jonga Powder} twice from
\npc{Almagorte}. Save a use of \gameItem{Jonga Powder} for after this Tower
by the way. You'll need it.

\faqentry{What are these little \gameItem{Golden Idols} for?}
...
\faqentry{(Pick a level) of the \place{Dane Tower} is too hard!}

Then come back later when you're stronger. However, it is possible on expert
mode for a party created from level one characters to get to the \place{Temple of
Wanderers} after clearing out the \place{Starter Dungeon} and \place{New City}, so
...
Just so you know, when \npc{Tollen Dane} comes out to congratulate your rank,
...
It's a teleporter maze. Happy mapping---those teleporters aren't going to
show up. After a while the places you get sent to will look familiar Also,
turn on the \spell{Direction} spell (or look at your \gameItem{Journey Map
  Kit}) as there is a spinner teleporter as well. There are also two
teleporters here that will send you back to the \place{Temple of Eternal
  Night}, which can be a blessing or a pain depending on whether you need a
couple of drinks at the fountain or not.
...
check your \gameItem{Journey Map Kit} to see if new areas opened up, and if
your mapping skill is below 30 here, you're going to be in big trouble. Keep
in mind that when I say alcove, I mean a 1$\times$1 room that only has one
way in and out.
...
\faqentry{Ack! The \gameItem{Ring of Demons} is killing me when I put it on!}
...
the \gameItem{Faerie Cap} from the chest in the \place{Temple of Deadly
  Coffers}, or the one with the \gameItem{Chrome Key} in the \place{Temple of
  Wanderers}, it is safe to put it on him or her---the \race{Faerie} will
just lose the HP regen bonus because it cancels out. As a note about negative
Regen items, the game appears to take the highest regeneration bonus out of
all the items you have, and add the lowest negative regeneration penalty of
the items you have to it, to get an end result. That means that if you have a
\gameItem{Ring of Demons} and both \gameItem{Gowns of Divine Mail} on the
same character, that character ends up with no regeneration bonus,
\textlcsc{NOT} a Regen~+2 bonus. So that Regen~+1 item allows you to have as
many −1 regen items equipped as you want.
...
Whatever you want. You need the \gameItem{Coil} for later though.\goodbreak
...
\begin{itemize}[WviiTwoColumn]
  ...
  \item \npc{General Yamo}\textsuperscript{fixed}
  \item \npc{Sgt.~Balbrak}\textsuperscript{fixed}
  \item \npc{Lt.~Gromo}\textsuperscript{fixed}
...
Either way, find an Umpani NPC (\npc{Rossarian} in the \place{Arms of Argus}
at \place{New City} is ideal) and Truce until the NPC is willing to trade
with you.  If you're using Wizardry Gold however, you're out of luck due to
the bug with diplomacy (bug being that it just simply doesn't work\ldots{}at
all).

\faqentry{Should I join the Umpani?}

Definitely---even if you hate them. You can betray them for the T'Rang by
helping \npc{K'borra} and lying about his presence near \place{Ukpyr} to the Umpani
...
\faqentry{Should I help \npc{K'borra} and the T'Rangs?}

Again, it is totally up to you. You may want to know that I've yet to get any
compensation from \npc{K'borra}, although it may involve me finding him
again. Supposedly though, you need to talk to \npc{Shritis} to get your
reward.

\faqentry{Where exactly is information \npc{K'borra} wants?}

It's in the \place{Spaceport Authority}. If you're going to help \npc{K'borra},
...
\faqentry{I'm giving \npc{K'borra} the information he wants, but he's calling me a
  traitor! Why?}
...
Supply Depot, and then be offered 14250 for a \gameItem{Blunderbuss} and
\gameItem{Flak Jacket}. No discounts on that unfortunately.  If you want the
items though, get them before meeting \npc{General Yamo}.
...
\begin{twocolumnitemize}{Monsters encountered:}
  ...
  \item \place{Rattkin Ruins}
    \begin{itemize}
      \tightlist
    \item \monster{Grimal}\textsuperscript{fixed}
    \item \monster{Rattkin Razuka}\textsuperscript{fixed}
...
\faqentry{What do I do after all the \monsterB{Man~O'~Grove}{Man O' Grove} fights?}

You see that little square that isn't grass in the middle of all the
1$\times$1 pillars? Use the \gameItem{Bonsai Tree} you got from Murkatos'
\place{Inner Sanctum} on it. It doesn't matter what you answer when you get
asked a question by the tree.
...
Because if you did go here before using the \gameItem{Bonsai Tree} in that
Grove, the tree wouldn't let you up.

\faqentry{I can't get in \place{Ratskells}!}
...
\faqentry{How do I get in the \placeB{Funhouse}{Rattkin Funhouse}?}

Ask \npc{Blienmeis} about ``\placeB{Funhouse}{Rattkin Funhouse}''. Oh, and
have 1000 gold before you do.

\faqentry{What do I do in the \placeB{Funhouse}{Rattkin Funhouse}?}

You're going to be setting up a lot of things. You \textlcsc{need} a
\spell{Detect Secret} or a good amount of scouting skill in here---especially
after going downstairs---or you won't be able to find the necessary items
needed to set up the place. You need various items found throughout the
\placeB{Funhouse}{Rattkin Funhouse} and a \gameItem{Feather Weight} potion
from Birdie's store. Don't forget the \gameItem{Black Pyramid} and the
\gameItem{Wooden Dowel} from upstairs! After you've set everything up, save,
use the \gameItem{Feather Weight} potion (but on the main screen!) and set
things off.

\faqentry{What does \npc{Barlone} want?}

Give him a time of the next T'Rang ship to leave\fshyp{}come. You should find
the information in the \place{Landing Port} (in the form of the
\gameItem{T'Rang Logbook}) and the \place{Observation Control Center} (in the
form of the \gameItem{TX-Coder}) in \place{Nyctalinth} Use the Coder on the
Logbook while you're in the full-screen view of your inventory to read
it. You're advised to go to \place{Nyctalinth} at this point---the
information \npc{Barlone} gives you will give you access to the
\qmwordqm{DRAGON} map in \place{Old City}, but the \qmwordqm{DRAGON} map is
one of the maps that tends to get taken away real fast---hence the need for
haste. The \qmwordqm{BOAT} map in the \placeB{Funhouse}{Rattkin Funhouse}
...
\faqentry{Aack! There's \textlcsc{more}? When does this
  ``\placeB{Funhouse}{Rattkin Funhouse}'' end?!?}
...
Throw the \gameItem{Speckled White Ball} at it of course. Look for some
``cascading troughs'' as the game calls it and jump in to find said ball.
...
\item \monster{Spirits}
\item \monster{Ghosts}
\item \monster{Puxic Oozes}\textsuperscript{fixed}
\item \monster{Fungus Oozes}
\item \monster{Water Nymphs}
\item \monster{Dragonlizards}
\item \monster{Iguanadons}
...
probably your first \gameItem{Ankh}. Most Ankhs can raise either Strength,
Vitality, Dexterity, Piety, or Speed, depending on what type of Ankh it
is. There are other Ankhs that do other things, but most of the ones that you
run across will be the stat-raising kind. If you already knew what to do to
get in however, you can go in here as early as after \place{Orkogre Castle}.
...
\item \place{Nyctalinth}
  ...
  \item \npc{H'Jenn-Ra}\textsuperscript{fixed}
  \item \monster{Rattkin Leaders}
  \item \monster{Rattkin Hunters}
  \item \monsterB{Rattkin Thieves}{Rattkin Thief}
  \item \monster{Savant Controllers}
  ...
  \item \monster{Fetid Corpses}
  \item \monster{Zombie Skells}
  \item \monster{Ymmu}\textsuperscript{fixed}
  \item \monster{Vilet Kanebe}\textsuperscript{fixed}
  \item \monster{Dragon Rooks}
  \item \monster{Hog Beetles}
  \end{itemize}
...
you've killed \npc{Rodan} or not until you kill \npc{Rodan} and keep his
\gameItem{Golden Medallion} to present to \npc{Shritis}, or until he gets
immensely ticked off at you and attacks you every time he sees you.
...
missile weapons, including \gameItem{Blunderbuss}es and \gameItem{Muskets}.
Of course, if you say no to \npc{Shritis} you're going to have to tread
lightly every time you see him---he'll be cranky when he sees you again, but
at least he won't be trying to hunt you down unless you kill T'Rang NPCs
(including \npc{K'borra}).

\faqentry{Should I go back to \place{Nyctalinth} after talking to
  \npc{Shritis} instead of going into \place{New City}?}

Yes, unless you got the information from \npc{Barlone} already---if you did
you should head for \npc{Professor Wunderland} and the entrance to \place{Old
  City} to get the \qmwordqm{DRAGON} map quickly before someone steals it.

\faqentry{Why don't these \gameItem{Finger Rods} work on the \place{Breeding
    Grounds} door?}

Because they're for the \place{Tactical Depot}. The one for the \place{Breeding
  Grounds} can be found in the \place{High Chamber} on a T'Rang who is
cooking gruel.

\faqentry{What is the \gameItem{Mystery Ray} for?}

You will use it on any \monster{Savant Androids} you may find---especially
the sleeping ones in the T'Rang larder in the \place{High Chamber}. Use it as
an item when it prompts you with the Use, Talk, and Leave buttons. You can
\emph{also} use the \gameItem{Mystery Ray} to hurt \emph{any} \monster{Savant
  Androids} you run across---including those nasty \monster{Savant Kui'sa-ka}
near the end of the game and those \monster{Savant Berserkers} you wake up.

\faqentry{Is the information that the \monster{Savant Berserker} spoke and
  the stuff that flashed on the computer screen in the \place{Observation
    Center} important?}

You betcha. Take a walk into the \place{Forbidden Zone} after you're bored of
\place{Nyctalinth}. Make sure you have the \gameItem{Comm-Link Device} from
the \place{Umpani Detache} first though. BTW, if you helping \npc{Barlone}, I
hope you remembered to look for the \gameItem{TX-Coder} in the
\place{Observation Center}. Otherwise you won't be able to read the
logbook. Told you to build up scouting!

\faqentry{What do I do in the \place{Graveyard}? All I see are lots of
  graves, a building, and two alcoves with a psycho ghost who steals a
  jeweled staff before I can grab it.}

Well, you \textlcsc{have} to do three things: You have to grab the
\gameItem{Longstem Spade} in the chest in the building here---it's going to
be your shovel and you're going grave robbing! \verb|:)| You also have to dig
out the grave of Notera Furmi (Not Firm) to get out of here. Lastly, you have
to get the \qmwordqm{SERPENT} map from the \place{Tomb of Vilet Kanebe}
behind the energy barrier, and that means getting that \gameItem{Crux of
  Crossing} away from the crazy ghost and equipping the cursed (literally)
staff on someone while going through the barrier---both in and out. That also
means that you're going to be in the graveyard at least twice---you need a
little idol called the ``\gameItem{Tydnab Emyt}''\footnote{Time Bandit
  backwards with y's for i's} which can only be found in the middle area of
\place{Nyctalinth}--if you took out your Journey Map kit and looked at that
big black spot in the middle of the map, you'd find it somewhere in the
middle of that. Unfortunately you have to go through the graveyard to get
there.
...
that is blocked by T'Rang eggs---you need a \gameItem{Thermal Pineapple} to
get out this way, and if you have that you should know that one heck of a
fight is on your way out if you choose to go out that way\ldots{}and you
can't avoid it if you insist on using this route as the way out.

\faqentry{I'm in the middle area now. So where exactly is the Tydnab Emyt?}

It's beneath a statue of \npc{Phoonzang}. (What a surprise\ldots{}) Use the
\gameItem{Spade} to dig it up after you deal with the undead waiting in
ambush where the statue is.

\faqentry{So how exactly do I get the \gameItem{Crux of Crossing}?}
...
\gameItem{Tydnab Emyt} and watch.
...
I guess you had a \gameItem{Pineapple} after all. I won't lie to you---if
your party is not faster than \npc{H'Jenn-Ra}'s party, you're screwed unless
you're on easy mode, where there's a chance she'll appear by herself, or
you're much higher level, where most of their stuff has a reduced chance of
working on you. You will need the full gamut of protective and enhancement
spells to kill her otherwise, including \spell{Air Pocket} but not Fire or
\spell{Ice Shield} unless she has company. On Expert mode, you need at least
2 characters that can cast mass target spells like \spell{Nuclear Blast} or
...
Well, if you've returned the \gameItem{Holy Work} to \npc{Xen Xheng} and
joined his school of 5 Flowers, you can start collecting the flowers for
one. If you haven't read the \gameItem{Book of Fables} from \place{New City}
yet, take it out and read it now, and remind yourself about when the witches
meet. This next part doesn't seem to be hinted anywhere in the game---you
have to high-tail it to the \place{Giant Cave}. That means you're going to be
looking for a path \textlcsc{DOWN}, so you're going to look for a cliff where
if you take another step, you fall into the air. Make a mental note of a
place where you can climb up if you find it first---you will go there
later. If you end up near a river, you're in the wrong direction---you're on
the \place{Eryn River} right now, which you've been to before.
...
\begin{twocolumnitemize}{Monsters encountered:}
  \tightlist
\item \WviiSPOT{}\textsuperscript{fixed}
\item \monster{Gruengard}\textsuperscript{fixed}
\item \monster{Bonehead}\textsuperscript{fixed}
\item \monster{Brunatz}\textsuperscript{fixed}
\item \monster{Munstachio}\textsuperscript{fixed}
\item \monster{Boulder Giants}
\item \monster{Forest Giants}
\item \monster{Frost Giants}
\item \monster{Water Nymphs}
...
Yes. \WviiSPOT{} has the \gameItem{Necromantic Helm} somewhere in his lair.
Look for it; it's the witching glass mentioned in the \gameItem{Book of
  Fables}.  Also, the \gameItem{Red Rosis} is in the underground river. If
you can swim four or more steps (and have a mass target spell) go to the
nearest access to the underground river east of the entrance to the giant
caves and swim south to that little chokepoint of water (where you fight a
lot of fishes---hence the need for the mass target spell)---the \gameItem{Red
  Rosis} should be on that little piece of dry land right next to you to your
west. The alternate (and slower way) is to take the far eastern entrance to
the water and swim to another region of the caves that will wrap around the
bottom area and stick you near the \gameItem{Red Rosis}\ldots{}after a couple
fights.
...
hour comment from the \gameItem{Book of Fables}? That's right---you need to
explore around at night. If you find the area here that gives your characters
the chill, stay out of the clearing, rest until night, and then go back in
with the \gameItem{Necromantic Helm} equipped. Too bad nothing seems to
really hint that the \gameItem{Necromantic Helm} is the ``witching
glass''. You can also find the \gameItem{White Dahlia} in this area.

\pagebreak\subsection{\place{Witch Cave}}\label{witch-cave}\nopagebreak
%
\begin{twocolumnitemize}{Monsters encountered:}
  \tightlist
\item \qmwordqm{Alethedies}\textsuperscript{fixed}
\item \qmwordqm{Dk.~Savant}\textsuperscript{fixed}
\item \qmwordqm{Vi~Domina}\textsuperscript{fixed}
\item \qmwordqm{Statue}\textsuperscript{fixed}
\item \monster{Witch's Lights}\textsuperscript{fixed}
\item \monster{Spirits}
\item \monster{Ghosts}
...
\faqentry{What exactly is this \gameItem{Elysiad of Divinity}?}
...
\item \monster{Wood Dryads}
\item \monsterB{Faerie Witches}{Faerie Witch}
\item \monsterB{Mtn. Thraxes}{Mtn. Thraxe}\textsuperscript{fixed}
\end{twocolumnitemize}
...
Read that handy \qmwordqm{SPHINX} map you just got. The \gameItem{Rebus Egge}
that you got from attempting to get the \gameItem{Wand Majestik} in
\place{New City} is used here---you \textlcsc{DID} assay\fshyp{}identify it
eventually to find out what it was to tell it apart from other stones right?
It's the ``seed'' the map refers to. You're going to need to swim at most 3
to 4 spaces by the way.
...
\item Below ground
  ...
  \begin{itemize}
    \tightlist
  \item \monsterB{Ghosts of Gorn}{Ghost of Gorn}\textsuperscript{fixed}
  \item \monster{Ungorn Daimyo}\textsuperscript{fixed}
  \item \WviiDOOM{}\textsuperscript{fixed}
...
Use the \gameItem{Wand Majestik} on it. If you're a Greek Mythology buff (or
at least have been paying attention when the \npc{Sphinx} was talking
before!)  you'll know the question she refers to, but you don't have to get
the question right.

\faqentry{Waaa! That's a lot of booby traps!}

Yep. Save often. You're looking for secret buttons and levers. You're also
looking for a gold urn to burn that extra use of \gameItem{Jonga Powder}.
Aren't those traps nasty? If you want an (easier) time getting to the urn,
after you get to the area with fountains go east (turn left that is) and hug
the left wall until you get to all the little alcoves, then hug the right
wall, ignoring any alcoves for the moment. You'll only run into a few fixed
encounters for the first half of the way and get smacked by Evilspeak once or
twice along the second half.
...
\faqentry{OK, so I've burned the \gameItem{Jonga Powder} and turned off the
  nasty traps.  What now?}
...
is a \gameItem{Dragon Kite}---a shield for \class{Valkyrie}s,
\class{Fighter}s, and \class{Lord}s that reduces their armor class by
4. That's if you have them and need one however. Otherwise, a \gameItem{Faerie
  Cap} if you missed it before (or Chamail items) is the \nth{2} best. Most
of the other stuff is overshadowed by better loot elsewhere. Bt the way,
search all the \monster{Gorn Noblemen} you can find, but save before doing
so!
...
\begin{twocolumnitemize}{Monsters encountered:}
  \tightlist
\item \monster{Emerald Dragons}\textsuperscript{fixed}
...
going to need something from the \place{Dane Tower} here you know\ldots{}

\faqentry{Uh oh. \npc{Brombadeg}'s tough!}
...
\faqentry{Where do I use the \gameItem{Key of the Dragon}?}
...
\item \monster{Savant Controllers}
\item \monster{Savant Guards}
\item \monster{Helazoid Aces}\textsuperscript{fixed}
\item \monster{Xenozoid Runners}
\item \monster{Xenozoid Flyers}
\item \monster{T'Rang Elders}
\item \monster{T'Rang Assassins}
\item \monster{T'Rang Watchers}
\item \monster{Meta-Droid}\textsuperscript{fixed}
\item \monster{Ravens}
\end{twocolumnitemize}
...
\npc{Dame Ke-Li}---if you don't have a \gameItem{Credit Card} you have to go
there first---and then you probably want to buy some of her fun supply of
items as well.
...
sells \gameItem{Credit Card}s for 100 gold.

\faqentry{How do I get into the \place{Storage Facility}?}

The \gameItem{Storage Key} for the \place{Storage Facility} is in the
\place{Hall of Preservation}.

\faqentry{What about that gazebo with the glowing key? There are invisible
  walls around it.}

You need to get into the \place{Storage Facility} first. Then go into an
alcove on your way out (through the other side---there are two exits in the
\place{Storage Facility}).

\faqentry{What is the \gameItem{Key of Light} used for?}
...
Like all choices, it is up to you. The \gameItem{Frontier Phasers} and the
\gameItem{Cobaltine Power Glove} require \gameItem{Powerpaks} for use
however. If you've imported your party from Bane of the Cosmic Forge, you
probably have the \gameItem{Diamond Ring} which can open another one. The
\gameItem{Light Sword} and the \gameItem{Power Glove} get bonuses when
fighting against robots like the \monster{Battle Droid} (but not against
\monster{Savant Androids}). Be warned that when you use the \gameItem{Diamond
  Ring} to grab an item, the Ring gets sacrificed for the item.

\faqentry{Anything special I should do with \npc{Dame Ke-Li}?}

You mean besides buy all those nice, wonderful things she's selling?
Yeah---give her the \gameItem{Helazoid Pendant} you got from \npc{Jan-Ette}
if you helped \npc{Jan-Ette}. Other than that, she's the perfect person to
have fun using the Five Fingered Discount. Just don't get caught.

\faqentry{What exactly does that \gameItem{PK Crystal} do?}

−4~AC bonus, Regen~+1, Psionic Resistance +50\%, usable only by
\class{Psionic}s.

\faqentry{What are the answers to the tests in the \place{Hall of Crusaders}?}
...
\faqentry{Where can I get more \gameItem{Powerpaks}, other than killing lots of Helazoids?}

Buy those \gameItem{Credit Card}s from \npc{Dame Ke-Li} and use them in a
machine in the \place{Storage Facility}---the machine gives out
\gameItem{Powerpaks} for Credits. If you really have to make money at this
point, you \emph{can} keep getting \gameItem{Powerpaks} and then selling them
...
\begin{twocolumnitemize}{Monsters encountered:}
  \tightlist
\item \monster{Ra-sep-re-tep}\textsuperscript{fixed}
\item \monster{Thing from Hell}\textsuperscript{fixed}
\item \monster{Horragoth}\textsuperscript{fixed}
\item \monster{Myxlmynx}\textsuperscript{fixed} / \monster{Fieros}\textsuperscript{fixed}
\item \monster{D'Arboleth}\textsuperscript{fixed}
\item \monster{Wraiths}\textsuperscript{fixed}
\item \monster{Fiend of 9 Worlds}\textsuperscript{fixed}
\item \monster{Beast of 1000 Eyes}\textsuperscript{fixed}
...
Do you have the \qmwordqm{LEGEND} map? It's also called the \gameItem{Gaelin
  Legend}.  Funny, there's a stone in the same area called the \place{Gaelin
  Stone}. I wonder if there's a connection\ldots{}maybe you can use the map
on the stone somewhere.
...
\faqentry{I want to kill the \monster{Gorrors}! Can't you suggest anything?}
...
\paragraph{\monster{Ra-sep-re-tep}} If you actually need help on him, that's
not a good sign.  \verb|:)|
...
someone who can't hide with the \gameItem{Necromantic Helm}, \gameItem{Bat
  Necklace} or another Light-resisting item like the \gameItem{Helazoid
  Pendant}, and have him take all the \spell{Dazzling Lights} hits;
\spell{Dazzling Lights} will go straight for the character if he's the only
one visible, but with 100\% so Light resistance + \spell{Magic Screen}, you
should be able to resist it and shrug it off.  This is because if everyone is
invisible and the Beast casts \spell{Dazzling Lights} at you (because you had
someone visible in the beginning of the round), it is more likely to hit
...
of \gameItem{Moser's Mojo Tea} your first time through, as well as Heavy
...
You'll need to find the \gameItem{Key of Waters} and open a gate elsewhere
that opens into the same room. As long as you avoid the teleporter spot,
...
\faqentry{Great, I've found the \gameItem{Star Map}. How exactly do I use it?}
...
(the \gameItem{Temple Map}) and write it down. Move to the next face on the
right side of the stone (in other words, circle the stone counterclockwise)
repeating the same thing but using the top section only. Once you're back on
the side with the Man, do the same thing for the bottom row. The buttons will
fall into place.
...
\begin{twocolumnitemize}{Monsters encountered:}
\tightlist
\item \npc{Dk.~Savant}\textsuperscript{fixed}
\item \monster{Savant Kui'sa-ka}\textsuperscript{fixed}
\item \monster{Cosmo-Bots}\textsuperscript{fixed}
\item \monster{Mega-Bots}\textsuperscript{fixed}
\item \monster{Meta-Droids}\textsuperscript{fixed}
\item \monster{Battle Droids}\textsuperscript{fixed}
...
\spell{Missile Shield} may deflect them. The \gameItem{Light Sword} and
\gameItem{Power Glove} will do double damage to these guys though.
...
\faqentry{Hey! Is the \npc{Astral Dominae} gone?}

No. Just signal \npc{Vitalia} to come on down and give her the \gameItem{Ring
  of the Globe} and the \gameItem{Locket of the Tomb}.
...
\faqentry{And while we're baffled, how the heck do we signal \npc{Vitalia}?}

You \emph{did} visit the \place{Forbidden Zone} in \place{New City} after
getting that strange information from the \monster{Savant Berserker} and the
\place{Observation Center} in \place{Nyctalinth} and the \gameItem{Comm-Link
  Device}\ldots{}didn't you?

\faqentry{Why does the \npc{Dark Savant} keep wiping the floor with my party?}

You're just unlucky. \texttt{:(} Still, you can use the
\gameItemB{Elysiad}{Elysiad of Divinity} in this fight, and this fight
only. Personally, I didn't really need it. The \gameItem{Mystery Ray} was
helpful too, at least on the \monster{Kui'sa-ka}. Hope you have 100 Mind
Control by the way: they \textlcsc{LOVE} \class{Psionic}s.

\faqentry{Why does \npc{Vitalia} ask me about a spaceship?}

This decides what endings you can get. Yes means that you have to go to
\npc{Phoonzang}'s shuttle to grab an ending. No means you go back to the
\place{Forbidden Zone} for the endings, although I didn't have problems
getting an ending from \npc{Phoonzang}'s shuttle as well by saying no.
...
\pagebreak\section{Spoilers}\label{spoilers}
%
...
\gameItem{Poet's Lute} & Sleep & Most bards start with it. \\[1.2ex]
\gameItem{Angel's Tongue} & \spell{Bless} & Buy/steal from \npc{Brother TShober} when you first meet him. \\[1.2ex]
\gameItem{Chromatic Lyre} & Itching Skin & \place{Land of Dreams}. \\[1.2ex]
\gameItem{Lute of Sloth} & Slow & Search the area where you summoned \monster{Maa-Gogg} the \monsterB{Man~O'~Grove}{Man O' Grove} for a chest. \\[1.2ex]
\gameItem{Silent Lyre} & Silence & \place{Dionysceus}, in the \gameItem{Book of Immortals} chest. \\[1.2ex]
\gameItem{Pipes of Doom} & Terror & Buy\fshyp{}steal from \npc{Blienmeis} at \place{Ratskells} in \place{Rattkin Ruins} when he is in \place{Ratskells}. \\[1.2ex]
\gameItem{Cornu of Demonspawn} & \spell{Astral Gate} & Kill \WviiSPAWN{} \\[1.2ex]
\gameItem{Siren's Wail} & Confuse & \place{Dragon Mountains}, in the pirate chest or a Gorrors chest. \\[1.2ex]
\gameItem{Horn of Prometheus} & \spell{Fireball} & Gorrors chest or a certain \place{Hall of Past} chest. \\[1.2ex]
\gameItem{Lyre of Cakes} & Healthfull\footnotemark{} & A certain \place{Hall of Past} chest---you choose between this and the \gameItem{Horn of Prometheus}. \\ \bottomrule
\end{longtable}

\footnotetext{\gameItem{Lyre of Cakes} has been proven to not give back your health. People
  have theorized that it instead acts like a mass version \spell{Cure Lesser
  Condition}.}
...
\gameItem{Dahlia} with the other 4 merged flowers. Only one person can get this.

\paragraph{Reflextion} Ask \npc{Blienmeis} about ``Reflextion'' when he is in
\place{Ratskells}. He will offer to sell you a \gameItem{Ring of Reflextion}
for 12000 gold.  Use the Ring's special ability to give the character using
it Reflextion. Only one character\fshyp{}game can get this.

\paragraph{Power Strike} Use the \gameItem{Gem of Power}'s special ability to
give the character using it Power Strike. The \gameItem{Gem of Power} is
located in the secret room in Murkato's \place{Inner Sanctum}. Only one
character\fshyp{}game can get this.

\paragraph{Eagle Eye} Rescue \npc{Jan-Ette} from the \monster{T'Rang
  Assassins}. Give the \gameItem{Helazoid Pendant} she gives you to \npc{Dame
  Ke-Li} at \place{City of Sky} for the \gameItem{Helazoid Pendant}. Use the
Pendant's special ability to give the character using it Eagle Eye. Only one
character\fshyp{}game can get this.

\paragraph{Mind Control} Kill the \monster{Psi-Beast}(s) on the \place{Temple of
...
\faqentry{Can I get the other items in the \place{Hall of Preservation}?}

As far as I know, the answer is no if you didn't import a party from Bane of
the Cosmic Forge. The \gameItem{Diamond Ring} you get in Bane of the Cosmic
Forge can open up the doors as well, although like the \gameItem{Key of
  Light} it goes away when you use it---which means you have to decide
whether the item inside is worth losing a −5~AC accessory that females can
use. In my opinion, the \gameItem{Cobaltine Power Glove}, the \gameItem{Light
  Shield}, and the \gameItem{Light Sword} are all worth it, but not the
\gameItem{Frontier Phasers}.
...
\item \npc{Lord Galiere} and \npc{King Ulgar}
  \begin{itemize}
    \tightlist
    \item \gameItem{Spear}
    \item \gameItem{Awl Pike}
    \item \gameItem{Spear+2} (rarely or only in the beginning of the game)
    \item \gameItem{Quilt Tunic} (sometimes)
    \item \gameItem{Quilt Leggings} (sometimes)
    \item \gameItem{Fur Leggings} (sometimes)
    \item \gameItem{Cuir Gauntlets} (sometimes)
    \item \gameItem{Leather Cuirass} (sometimes)
    \item \gameItem{Studded Hauberk} (sometimes)
  \end{itemize}

\item \npc{Capt.~Boerigard}
  \begin{itemize}
    \tightlist
    \item \gameItem{Spear+2}
    \item \gameItem{Studded Hauberk}
  \end{itemize}
...
\item \npc{Xen Xheng}
  \begin{itemize}
    \tightlist
    \item \gameItem{Sai} (sometimes)
    \item \gameItem{Nunchuku} (sometimes)
    \item \gameItem{Ninjato} (sometimes)
    \item \gameItem{Shuriken} (15)
    \item \gameItem{Bushido Blade} (higher levels)
    \item \gameItem{Do-Maru~(U)}
    \item \gameItem{Do-Maru~(L)}
    \item \gameItem{Tosei-Do~(U)} (higher levels)
    \item \gameItem{Tosei-Do~(L)} (higher levels)
    \item \gameItem{Ninja Cowl}\protect\tikzmark{xen-xheng-topbrace}
    \item \gameItem{Ninja Garb~(U)}
    \item \gameItem{Ninja Garb~(L)}
    \item \gameItem{Tabi Boots}\tikzmark{xen-xheng-bottombrace}
...
\item \npc{Kymas Turan}
  \begin{itemize}
    \tightlist
    \item \gameItem{Mitre}
    \item \gameItem{Brimstone Nuggets}
    \item \gameItem{Ju-ju Stones} (sometimes)
    \item \gameItem{Dragon's Teeth} (sometimes)
    \item Random scroll
    \item Random scroll
...
\item All Umpani NPCs
  \begin{itemize}
    \tightlist
    \item \gameItem{Powder and Shot} (25) (sometimes)
    \item \gameItem{Walriblade} (sometimes)
    \item \gameItem{Flak Vest} (sometimes)
  \end{itemize}

\item All T'Rang NPCs
  \begin{itemize}
    \tightlist
    \item ??? (I think nothing, but possibly \gameItem{Shock Rod})
  \end{itemize}
...
\item \npc{Jan-Ette}
  \begin{itemize}
    \tightlist
    \item \gameItem{Credit Card} (most of the time)
    \item \gameItem{Powerpak} (sometimes)
  \end{itemize}
\end{twocolumnitemize}
...
early. (You have to get in anyway.) Leather and \gameItem{Studded Hauberk}s
may be helpful as well as the bows and the occasional naginata or halberd.
...
When you open the chest there though, you will get a \gameItem{Crusaders's 2H
  Axe~+1}, \gameItem{Bracers of Defense}, \gameItem{Chain Mail~+1 (U)},
\gameItem{Chain Mail~+1 (L)}, and a \gameItem{Crusader Helm} as well as gold.
...
the \gameItem{Journey Map Kit} and as west and south as possible (you may
have to explore the entire west area) until you both hit water and can't go
west anymore. Now, if you have some area effect spells like \spell{Fireball}
handy and lots of Water points for Stamina spells (or lots Stamina potions),
look at the area this way.
...
Go in and get your \gameItem{Plate Mail~+2} (both upper and lower) and some
random loot.  Reload the loot until you see some weapon you like---I like the
\gameItem{Cat~O'~9 Tails}, but some may like the \gameItem{Vulcan Hammer} or
\gameItem{Sword of Fire}.
...
and search, you'll find a \gameItem{Broadsword~+1} and random loot. Reload
until you get something you like, which may include a Dragon Kite.
...
\gameItem{Displacer Cloak} (you better have inventory room before talking!)
for 40,000 gold. The loot is decent and can include a \gameItem{Dragon Kite}
(again).
...
at Chamail items, a \gameItem{Faerie Cap}, or a \gameItem{Dragon Kite}
without wasting a spot in a Gorrors chest (although you might get the Dragon
Kite again in the \place{Dragon Cave}).
...
\gameItem{Kabuto}, a \gameItem{Bushido Blade}, and a \gameItem{Wakizashi~+1}

\faqentry{Where can I get the \gameItem{Cane of Corpus}?}
...
\paragraph{\place{New City}} In the \place{Control Center}, stick the
\gameItem{Black Wafer} instead of the \gameItem{Control Card} in the slot to
summon \monster{Savant Guards} and \monsterB{Troopers}{Savant Troopers}.
...
can't use the \gameItem{Medicine Bag}, but you're not missing much from
it. If you want to just play for fun, anything can work. If you want to get
through the first areas quickly, you may opt for a simple party of two
\class{Fighter}s, a \class{Mage}, a \class{Priest}, a \class{Thief}, and a
\class{Bard} for relative speed through the initial parts. Heck, even a party
of all \class{Ninja}s can get through the game. If all else fails, use the
change profession button to get a class that you need at the moment once you
have the minimum stat requirements to change into the class.
...
economic type, you will hate any missile weapons, including the
\gameItem{Musket} and \gameItemB{Blunderbuss}{Blunderbuss}, which must be
reloaded every other turn in order for you to use it effectively. Keep in
mind however that missile weapons are long range, and can target monsters no
...
ailment (or just Blessing everyone constantly with the \gameItem{Angel's Tongue}).
...
Also, \gameItem{Chamail} and \gameItem{Chain Mail~+1} will transfer.  Nothing
else that you find in the last several areas of the game appear to transfer
though, so far, although the \gameItem{Wizard's Cone} should transfer.

\paragraph{Weapons} All Bows, Arrows, Crossbows, Quarrels, Slings, and Sling
Bullets appear to transfer, no matter what kind, with exception to the
\gameItem{Siege Arbalest}.  Any weapon you can buy in the \place{New City}
area when you initially enter the area also appears to transfer, but not
later equipment like \gameItem{Vorpal Blades}.  Also, \gameItem{Stun Rods}
transfer and are \textlcsc{HEAVILY} suggested as they do rather obscene
amounts of damage for a low level party. Although I don't have one on a
transferring party, the \gameItem{Spear+2} should most likely transfer as
well.  The \gameItem{Mystery Ray} transfers and goes from a weapon that only
hurts \monster{Savant Androids} to a weapon that can hurt anything.
Strangely enough, \gameItem{Powder and Shot} will transfer, but not
\gameItem{Muskets} or the \gameItem{Blunderbuss}.  Any \gameItem{Shuriken}
will transfer, so if you have \gameItem{Death Stars}, you keep them.

\paragraph{Miscellaneous} All reagents transfer.  The \gameItem{Book of
  Relics} transfers The \gameItem{Valentine Necklace} and \gameItem{Storage
  Key} are supposed to transfer according to “myrddin” on the Software
Specialties Wizardry~8 forum.  \gameItem{Bat Necklace}s transfer.  Scrolls,
Wands, and Potions transfer (even \gameItem{Moser's Mojo Tea}!).
\gameItem{Mana Stones} transfer.  \gameItem{Cross of Protection} apparently
transfers, according to Scronan of the Ironworks Wizardry~8 board.

\paragraph{Bardic Instruments} \gameItem{Poet's Lute}, \gameItem{Angel's
  Tongue}, \gameItem{Chromatic Lyre}, \gameItem{Siren's Wail},
\gameItem{Cornu of Demonspawn}, and \gameItem{Lute of Sloth} will transfer.

\paragraph{What definitely does not transfer} Any of the good \monster{Gorrors}
treasure.
...
%
\begin{itemize}
\item Software Specialties Wizardry~7 board \CotDS{} Clue
