...
\place{Starter Dungeon} or the one at \npc{Father Rulae}), the \monster{Ra-sep-re-tep} pool
...
for Xen Xheng after he leaves the dojo. (Locate Person scrolls
...
(where the fireballs are coming from) is the Temple of the \npc{Magna Dane},
which you will be able to get to after passing the Temple of Wanderers and
paying for your membership as a Lord of Dane. Be warned that going down this
...
with the \npc{Magna Dane} though, as the \npc{Magna Dane} will have left his
Temple. I've gotten stuck here before though, as the Pit exits here after a
bit of winding and my party just can't take 80--100+ HP fireballs at this
point.
...
\faqentry{\npc{Magna Dane} is \textlcsc{hard}. Every time I start the fight, half my
...
Try it from the \npc{Magna Dane}'s chamber. You \textlcsc{did} see that secret button
right?
