...
\subsection{\race{Human}}\label{human}%
%
...
\subsection{\race{Dwarf}}\label{dwarf}%
%
...
\subsection{\race{Gnome}}\label{gnome}%
%
...
\subsection{\race{Hobbit}}\label{hobbit}%
%
...
\subsection{\race{Faerie}}\label{faerie}%
%
...
\subsection{\race{Lizardman}}\label{lizardman}%
%
...
\subsection{\race{Dracon}}\label{dracon}%
%
...
\subsection{\race{Rawulf}}\label{rawulf}%
%
...
\subsection{\race{Felpurr}}\label{felpurr}%
%
...
\subsection{\race{Mook}}\label{mook}%
%
...
\subsection{\class{Mage}}\label{mage}%
%
...
\subsection{\class{Thief}}\label{thief}%
%
...
\subsection{\class{Ranger}}\label{ranger}%
%
...
\subsection{\class{Bard}}\label{bard}%
%
...
\subsection{\class{Psionic}}\label{psionic}%
%
...
\subsection{\class{Alchemist}}\label{alchemist}%
%
...
\subsection{\class{Valkyrie}}\label{valkyrie}%
%
...
\subsection{\class{Bishop}}\label{bishop}%
%
...
\subsection{\class{Lord}}\label{lord}%
%
...
\subsection{\class{Samurai}}\label{samurai}%
%
...
\subsection{\class{Monk}}\label{monk}%
%
...
\subsection{\class{Ninja}}\label{ninja}%
%
...
\subsection{\race{Elf} \class{Fighter}}\label{sec:elf-fighter}%
%
\race{Elf} Base stats:%
\begin{itemize}[topsep=0pt]
\tightlist
...
\subsection{\race{Felpurr} \class{Fighter}}\label{sec:felpurr-fighter}%
%
...
\subsection{\race{Faerie} \class{Thief}}\label{sec:faerie-thief}%
%
...
\subsection{\race{Elf} \class{Priest} (F)}\label{sec:elf-priest-f}%
%
\race{Elf} Base stats:%
\begin{itemize}[topsep=0pt]
\tightlist
...
\subsection{\race{Elf} \class{Mage} (F)}\label{sec:elf-mage-f}%
%
\race{Elf} Base stats:%
\begin{itemize}[topsep=0pt]
\tightlist
...
\subsection{\race{Elf} \class{Bard} (F)}\label{sec:elf-bard-f}%
%
\race{Elf} Base stats:%
\begin{itemize}[topsep=0pt]
\tightlist
...
\subsection{Starter Dungeon}\label{starter-dungeon}%
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
...
\subsection{\place{New City}}\label{new-city}%
%
...
\subsection{\place{Orkogre Castle}}\label{orkogre-castle}%
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
...
\subsection{\place{Munkharama}}\label{munkharama}\nopagebreak%
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
\item Encountered Everywhere
...
\subsection{\place{Dionysceus}}\label{dionysceus}
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
  \item Encountered Everywhere
...
\Needspace*{5\baselineskip}\subsection{\place{Ukpyr}}\label{ukpyr}\nopagebreak%
%
\WviiNeedSpace{}%
...
\subsection{\place{Rattkin Ruins}}\label{rattkin-ruins}
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
  \item Encountered everywhere
...
\subsection{\place{Old City}}\label{old-city}
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
  \tightlist
...
\subsection{\place{Nyctalinth}}\label{nyctalinth}
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
...
\subsection{\place{Witch Mountains}}\label{witch-mountains}
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
  \tightlist
...
\subsection{\place{Giant Cave}}\label{giant-cave}
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
  \tightlist
...
\subsection{\place{Witch Grove}}\label{witch-grove}
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
  \tightlist
...
\subsection{\place{Witch Cave}}\label{witch-cave}
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
  \tightlist
...
\subsection{\place{Ukpyr Mountains}}\label{ukpyr-mountains}
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
  \tightlist
...
\subsection{\place{Sphinx Cave}}\label{sphinx-cave}
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
  \tightlist
...
\subsection{\place{Isle of Crypts} \& \place{Mandolian Isles}}\label{isle-of-crypts-and-mandolian-isles}
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
\item Above ground
...
\Needspace*{6\baselineskip}\subsection{\place{Dragon Mountains}}\label{dragon-mountains}\nopagebreak%
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
  \tightlist
...
\subsection{\place{City of Sky}}\label{city-of-sky}
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
  \tightlist
...
\subsection{\place{Hall of Gorrors} (in the \place{Isle of
...
\subsection{\place{Hall of the Past}}\label{hall-of-the-past}
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
  \tightlist
...
\subsection{\place{Tomb of the Astral Dominae}}\label{tomb-of-the-astral-dominae}
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
\tightlist
...
\chapter{Spoilers}\label{spoilers}
%
...
\item[v1.95 (11/16/01)] Added a section about transferring to Wizardry~8 and made a
