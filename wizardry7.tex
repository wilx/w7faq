...
Funhouse and a \gameItem{Feather Weight} potion from Birdie's store. Don't
forget the \gameItem{Black Pyramid} and the \gameItem{Wooden Dowel} from
upstairs! After you've set everything up, save, use the \gameItem{Feather
  Weight} potion (but on the main screen!) and set things off.
...
the Umpani Detache first though. BTW, if you helping \npc{Barlone}, I hope
you remembered to look for the \gameItem{TX-Coder} in the \place{Observation
  Center}. Otherwise you won't be able to read the logbook. Told you to build
up scouting!
...
to get the \qmwordqm{SERPENT} map from the Tomb of Vilet Kanebe behind the
energy barrier, and that means getting that \gameItem{Crux of Crossing} away
from the crazy ghost and equipping the cursed (literally) staff on someone
while going through the barrier---both in and out. That also means that
you're going to be in the graveyard at least twice---you need a little idol
called the ``\gameItem{Tydnab Emyt}''\footnote{Time Bandit backwards with y's for i's}
which can only be found in the middle area of \place{Nyctalinth}--if you took
out your Journey Map kit and looked at that big black spot in the middle of
the map, you'd find it somewhere in the middle of that. Unfortunately you
have to go through the graveyard to get there.
...
It's beneath a statue of Phoonzang. (What a surprise\ldots{}) Use the
...
really hint that the Necromantic Helm is the ``witching glass''. You can also
find the \gameItem{White Dahlia} in this area.
...
machine in the Storage Facility---the machine gives out \gameItem{Powerpaks}
for Credits. If you really have to make money at this point, you \emph{can}
keep getting \gameItem{Powerpaks} and then selling them to \npc{Paluke}---or
anyone other than \npc{Dame Ke-Li}.
...
You're just unlucky. \texttt{:(} Still, you can use the \gameItem{Elysiad} in
this fight, and this fight only. Personally, I didn't really need it. The
\gameItem{Mystery Ray} was helpful too, at least on the
\monster{Kui'sa-ka}. Hope you have 100 Mind Control by the way: they
\textlcsc{LOVE} \class{Psionic}s.
