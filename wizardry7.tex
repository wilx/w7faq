...
\newcommand{\spellentry}[1]{%
  \subparagraph{\spell{#1}}\phantomsection\addcontentsline{toc}{subsubsection}{#1}\nopagebreak}
...
\subsubsection{\place{Starting Area} (Near \place{New
...
\subsubsection{\place{Ukpyr}}\label{ukpyr}
...
\faqentry{\texorpdfstring{Why do the Umpani immediately attack me when I
    enter \place{Ukpyr}?\protect\footnotemark{}}{Why do the Umpani immediately attack
    me when I enter \place{Ukpyr}?}}\footnotetext{From Bernice Carter.}
...
helping K'Borra and lying about his presence near \place{Ukpyr} to the Umpani if you
...
It's actually my name for the area of the \place{Ukpyr} Mountains you climb down into
from the tall cliff.
