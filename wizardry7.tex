...
haste. The \qmwordqm{BOAT} map in the Funhouse however doesn't go away for a
while in comparison to the \qmwordqm{DRAGON} map but it \textlcsc{DOES} go
away if you dawdle too long.
