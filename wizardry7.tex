...
at least a 30 in climbing skill. Don't say I didn't warn you\ldots{}\spell{Levitate}
...
at any time (\spell{Enchanted Blade}, \spell{Armorplate}, \spell{Magic
  Screen}, \spell{Detect Secret}, \spell{Direction}, \spell{Levitate}) are reflected in the
globes on top of the game screen and are cumulative in duration only.

Casting any of the other battle-helping spells (such as \spell{Bless},
\spell{Haste}, etc) outside of battle will have NO EFFECT, even if cast
before a fight or some action that causes damage of some sort, so don't waste
your spell points and stamina. Keep in mind that when casting the six
...
will twinkle; however if you have a weak \spell{Detect Secret}, the eye may not pick
up on some things.
...
your Climbing skill when you climb. \spell{Levitate} won't help you if you jump off a
cliff however; you'll still die. The power level in this case is for
duration, not damage prevented as a level~1 \spell{Levitate} will protect you from
falling into pits.
...
If you're referring to the \place{Umpani Detache} and the \place{T'Rshieches House},
...
\place{Forbidden Zone} however, unless you \textsc{want} to fight Savant Troopers and
Savant Guards.
...
the gate. Funny, why does my \spell{Detect Secret} eye glow when I pass by that splot
of blood in front?

\faqentry{I found these Boney Combs and Brushes. When is it used?}

Much, \textsc{much} later in the game. \place{Isle of Crypts} to be
...
high, or that you use \spell{Detect Secret} quite often. If your swimming isn't up to
...
need. Hope you have \spell{Levitate} handy.
