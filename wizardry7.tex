...
\newcommand{\spellentry}[1]{%
  \textbf{\spell{#1}\quad}\phantomsection\addcontentsline{toc}{subsubsection}{#1}\nopagebreak}
...
\WviiNeedSpace{}Profession changing suggestions:%
\begin{itemize}[WviiTwoColumn]
\item
...
\Needspace*{5\baselineskip}Profession changing suggestions:%
\begin{itemize}[WviiTwoColumn]%
\item
...
\subsubsection{\race{Faerie} \class{Thief}}\label{sec:faerie-thief}%
%
...
%
\WviiNeedSpace{}Monsters Encountered:%
\begin{itemize}[WviiTwoColumn]
\tightlist
\item
  Bambiphoots
