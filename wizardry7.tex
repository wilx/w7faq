...
Convenient Starting Professions\begin{itemize}
\tightlist
\item
...
Convenient Starting Professions\begin{itemize}[WviiTwoColumn]
\item
  \class{Fighter}
\item
  \class{Thief}
...
\pagebreak[3]Convenient Starting Professions\begin{itemize}[WviiTwoColumn]
\item
  \class{Fighter}
\item
  \class{Priest}
...
Convenient Starting Professions\nobreak\begin{itemize}[WviiTwoColumn]%
\item
  \class{Fighter}
\item
  \class{Thief}
...
\subsubsection{\race{Elf} \class{Fighter}}\label{sec:elf-fighter}
%
\race{Elf} Base stats:%
\begin{itemize}[topsep=0pt]
\tightlist
...
\subsubsection{\race{Felpurr} \class{Fighter}}\label{sec:felpurr-fighter}
%
...
\subsubsection{\race{Elf} \class{Priest} (F)}\label{sec:elf-priest-f}
%
\race{Elf} Base stats:%
\begin{itemize}[topsep=0pt]
\tightlist
...
\subsubsection{\race{Elf} \class{Mage} (F)}\label{sec:elf-mage-f}
%
\race{Elf} Base stats:%
\begin{itemize}[topsep=0pt]
\tightlist
...
\subsubsection{\race{Elf} \class{Bard} (F)}\label{sec:elf-bard-f}
%
\race{Elf} Base stats:%
\begin{itemize}[topsep=0pt]
\tightlist
...
\begin{multicols}{2}
\subsubsection{Thaumaturgy (\class{Mage} spellbook)}\label{sec:thaumaturgy-mage-spellbook}
%
...
\subsubsection{Theology (\class{Priest} spellbook)}\label{sec:theology-priest-spellbook}
%
\paragraph{Level 1 spells}
...
\subsubsection{Theosophy (\class{Psionic} spellbook)}\label{sec:theosophy-psionic-spellbook}
%
\paragraph{Level 1 spells}
...
\subsubsection{Alchemy (\class{Alchemist} spellbook)}\label{sec:alchemy-alchemists-spellbook}
%
\paragraph{Level 1 spells}
